  ...
  return (
    <AppLayout>
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        {results.length === 0 ? (
          <div role="alert" className="text-center py-16 bg-white rounded-2xl border border-slate-200">
            <div className="text-4xl mb-3">🔍</div>
            <p className="font-medium text-slate-700">Aucun professionnel trouvé</p>
